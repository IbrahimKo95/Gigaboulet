...
<nav class="w-full py-4 border-t border-b bg-gray-100">
    <div class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-center text-sm font-bold uppercase mt-0 px-6 py-2">
            <a href="/intelligence-artificielle" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Intelligence artificielle</a>
            <a href="/cybersecurite" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Cybersécurité</a>
            <a href="/realite-augmentee" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Réalité augmentée</a>
            <a href="/reseaux" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Réseaux</a>
            <a href="/automobile" class="hover:bg-gray-400 rounded py-2 px-4 mx-2">Automobile</a>
        </div>
    </div>
</nav>
